...
#função para exibição da tabela em si
    def calculate_budget(self, instance):
        ...
        grid.add_widget(Label(text=f'R$ {salary * 0.1:.2f}', font_size = 40, color = (159/255.0,226/255.0,191/255.0,1), bold = True))
        ...
        for category, percentage in zip(categories, percentages):
            ...
            value_label = Label(text=f'R$ {salary * percentage:.2f}', bold = True, font_size = 40, color = (159/255.0,226/255.0,191/255.0,1))
